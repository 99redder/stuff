...
- Main layout:
  - Left column cards: **Discretionary** (first — it's the card touched daily), Fixed Bills, Emergencies / Unplanned, Other Expense Overages, **401(k) Minimum Distribution (RMD)**
