...
- **Her phone PWA shows only Discretionary** — the emergencies / unplanned bucket is a planning number for the owner, not something she needs on her home screen, so the card and its bindings are gone from `mom-budget-phone.html`.
